...
export const networks: NetworkType[] = [
    //@ts-ignore
  {
    ...
    hookWhitelist: ['erd1qqqqqqqqqqqqqpgqxwakt2g7u9atsnr03gqcgmhcv38pt7mkd94q6shuwt'],
    accessToken: true,
  },
  //@ts-ignore
  {
...
export const delegationBlogPostUrl = 'https://elrond.com/blog/more-elrond-staking-is-coming/';
...
export const adapterSchema = object({
  adapter: string().defined().oneOf(['api', 'elastic']).required(),
