...
const AssetsCard = ({
    ...
    <div className={`flex-grow-1 mr-3 mb-spacer assets-card ${className}`} style={{ flexBasis: '0' }}>
        <div className="stats-small card card-small">
            <div className="px-0 pb-0 card-body">
                <div className="px-3 pb-3 d-flex flex-column">
                    ...
                    <p className="my-3">
                        <small className="text-uppercase mb-3 text-white text-nowrap">{label}</small>
                    </p>
                    ...
                    <Stats.UsdValue input={value} className="text-white" dataTestId={`${dataTestId}Usd`} />
                </div>
            </div>
        </div>
    </div>
